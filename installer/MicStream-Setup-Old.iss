...
[Files]
; Main application
Source: "..\MicStreamReceiver\bin\Release\net8.0\win-x64\publish\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
; Documentation
Source: "..\MicStreamReceiver\README.md"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\PHASE2_SUMMARY.md"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LICENSE.txt"; DestDir: "{app}"; Flags: ignoreversion
; VB-Cable installer (bundled)
Source: "..\installer\vbcable\VBCABLE_Setup_x64.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall; Tasks: installvbcable
; Helper scripts
Source: "..\installer\scripts\verify-installation.bat"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\installer\scripts\uninstall-vbcable.bat"; DestDir: "{app}"; Flags: ignoreversion
...
Filename: "{tmp}\VBCABLE_Setup_x64.exe"; StatusMsg: "Installing VB-Cable virtual audio driver..."; Flags: waituntilterminated runascurrentuser; Tasks: installvbcable; Check: VBCableNotInstalled
